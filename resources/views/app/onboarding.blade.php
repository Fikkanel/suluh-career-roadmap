<x-layouts.app title="Onboarding">
    ...
    <div class="max-w-xl mx-auto">
        <div class="alert alert-neutral mb-6">
            ...
            Semua pertanyaan wajib diisi untuk kelengkapan profil karirmu.
        </div>
        ...
        <form method="POST" action="{{ route('onboarding.store') }}" class="flex flex-col gap-6">
            ...
            <x-context-prompt
                question="Jurusan kuliahmu saat ini/terakhir?"
                helperText="Masukkan jurusan kuliahmu secara spesifik (misal: Teknik Informatika, Ilmu Komunikasi, Manajemen)."
                sensitivity="required"
                fieldName="major" />
